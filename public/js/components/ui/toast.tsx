    ...
    <ToastContext.Provider value={{ toasts, addToast, removeToast }}>
      ...
      <div class="fixed bottom-5 right-5 z-10000 flex flex-col gap-2.5 pointer-events-none">
        {toasts.map((toast) => (
          <div
            key={toast.id}
            class="bg-(--bg-card) border border-(--border-subtle) py-3 px-4 rounded-lg text-(--text-primary) flex items-center justify-between gap-3 shadow-[0_4px_12px_rgba(0,0,0,0.3)] pointer-events-auto min-w-50 max-w-87.5"
            style={{
